...
export const Seasons = ({ setSeason } : SeasonProps) => {
    ...
    return (
        <div className="bg-black h-screen p-20 grid grid-cols-2 gap- gap-44">
            {
                season1Data ? (
                    <button className="bg-gray-500 h-[60%] group" onClick={() => setSeason(1)}>
            ...
            {
                season2Data ? (
                    <button className="bg-gray-500 h-[60%] group" onClick={() => setSeason(2)}>
